...
const getOptcodes = (diagnostic, inputInstruction) => {
    ...
    while ( step < diagnostic.length) {
        ...
        let value1 = getValue({ diagnostic, mode: param1mode,
        ...
        switch (opCode) {
            ...
            case 2:
                ...
                diagnosticLocation = getLocation({
                    diagnostic,
                    mode: param3mode,
            ...
            case 7:
                ...
                if (value1 < value2) {
                    diagnostic[diagnosticLocation] = 1
                } else {
                    diagnostic[diagnosticLocation] = 0
                }
                increase = 4;
...
console.log(getOptcodes(input, 5));
//console.log(normalizeInstructions(123)); 
module.exports = {
